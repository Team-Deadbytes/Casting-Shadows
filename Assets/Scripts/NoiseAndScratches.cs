...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class NoiseAndScratches : MonoBehaviour
    {
        ...
        private float minDistanceMultiplyer;
        [Tooltip("Maximum distance between player and monsters that should generate glitches.")]
        public float maxDistance;
        private DistanceToMonsters minDistScript;
        public GameObject global;

        protected void Start()
        {
            minDistScript = global.GetComponent<DistanceToMonsters>();
        ...
        {
            minDistanceMultiplyer = this.minDistScript.getMinDistMultiplyer(maxDistance);
            SanitizeParameters();
            ...
            mat.SetVector("_Intensity", new Vector4(
                                            Random.Range(grainIntensityMin, Mathf.Clamp(grainIntensityMax * ((minDistanceMultiplyer + 1) * 5) - 5, grainIntensityMax, 5)),
