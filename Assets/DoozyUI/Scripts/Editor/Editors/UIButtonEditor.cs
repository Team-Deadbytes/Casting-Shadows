    ...
    public class UIButtonEditor : QEditor
    {
        ...
        void GenerateInfoMessages()
        {
            infoMessage = new Dictionary<string, InfoMessage>
            {
                ...
                { "OnPointerDownLoadPresetAtRuntime", new InfoMessage() { title = "Runtime Preset", message = onPointerDownPunchPresetCategory.stringValue + " / " + onPointerDownPunchPresetName.stringValue, type = InfoMessageType.Info, show = new AnimBool(loadOnPointerDownPunchPresetAtRuntime.boolValue, Repaint) } },
                { "OnPointerUpLoadPresetAtRuntime", new InfoMessage() { title = "Runtime Preset", message = onPointerUpPunchPresetCategory.stringValue + " / " + onPointerUpPunchPresetName.stringValue, type = InfoMessageType.Info, show = new AnimBool(loadOnPointerUpPunchPresetAtRuntime.boolValue, Repaint) } },
                ...
                { "OnDoubleClickLoadPresetAtRuntime", new InfoMessage() { title = "Runtime Preset", message = onDoubleClickPunchPresetCategory.stringValue + " / " + onDoubleClickPunchPresetName.stringValue, type = InfoMessageType.Info, show = new AnimBool(loadOnDoubleClickPunchPresetAtRuntime.boolValue, Repaint) } },
                { "OnLongClickLoadPresetAtRuntime", new InfoMessage() { title = "Runtime Preset", message = onLongClickPunchPresetCategory.stringValue + " / " + onLongClickPunchPresetName.stringValue, type = InfoMessageType.Info, show = new AnimBool(loadOnLongClickPunchPresetAtRuntime.boolValue, Repaint) } },
                { "NormalLoopLoadPresetAtRuntime", new InfoMessage() { title = "Runtime Preset", message = normalLoopPresetCategory.stringValue + " / " + normalLoopPresetName.stringValue, type = InfoMessageType.Info, show = new AnimBool(loadNormalLoopPresetAtRuntime.boolValue, Repaint) } },
                { "SelectedLoopLoadPresetAtRuntime", new InfoMessage() { title = "Runtime Preset", message = selectedLoopPresetCategory.stringValue + " / " + selectedLoopPresetName.stringValue, type = InfoMessageType.Info, show = new AnimBool(loadSelectedLoopPresetAtRuntime.boolValue, Repaint) } }
            };
        }
