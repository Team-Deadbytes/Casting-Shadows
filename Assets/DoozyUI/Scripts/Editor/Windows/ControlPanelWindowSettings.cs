...
namespace DoozyUI
{
    public partial class ControlPanelWindow : QWindow
    {
        ...
        AnimBool UIToggleAnimBool = new AnimBool(false);
        AnimBool UIToggleOnPointerEnterAnimBool = new AnimBool(false);
        AnimBool UIToggleOnPointerExitAnimBool = new AnimBool(false);
        AnimBool UIToggleOnClickAnimBool = new AnimBool(false);
        ...
        {
            if (ButtonBar("UIToggle", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelLarge), UIToggleAnimBool, width)) { UIToggleAnimBool.target = !UIToggleAnimBool.target; }
            if (QUI.BeginFadeGroup(UIToggleAnimBool.faded))
            {
                QUI.BeginHorizontal(width);
                {
                    ...
                    QUI.BeginVertical(width - INDENT_24);
                    {
                        ...
                        QUI.BeginHorizontal(width - INDENT_24);
                        {
                            DUI.DUISettings.UIToggle_allowMultipleClicks = QUI.Toggle(DUI.DUISettings.UIToggle_allowMultipleClicks);
                            QUI.Label("Allow Multiple Clicks", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 98, 18);
                            QUI.Space(16);
                            QUI.Label("Disable Button Interval", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 108, 18);
                            DUI.DUISettings.UIToggle_disableButtonInterval = EditorGUILayout.FloatField(DUI.DUISettings.UIToggle_disableButtonInterval, GUILayout.Width(40));
                            QUI.Space(16);
                            DUI.DUISettings.UIToggle_deselectButtonOnClick = QUI.Toggle(DUI.DUISettings.UIToggle_deselectButtonOnClick);
                            QUI.Label("Deselect On Button Click", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 118, 18);
                            QUI.FlexibleSpace();
                        }
                        QUI.EndHorizontal();
                        QUI.Space(8);
                        DrawSettingsUIToggleOnPointerEnter(width - INDENT_24);
                        QUI.Space(2);
                        DrawSettingsUIToggleOnPointerExit(width - INDENT_24);
                        QUI.Space(2);
                        DrawSettingsUIToggleOnClick(width - INDENT_24);
                        QUI.Space(10);
                    }
                    QUI.EndVertical();
                }
        ...
        {
            if (ButtonBar("OnPointerEnter", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelNormal), UIToggleOnPointerEnterAnimBool, width)) { UIToggleOnPointerEnterAnimBool.target = !UIToggleOnPointerEnterAnimBool.target; }
            if (DUI.DUISettings.UIToggle_Inspector_HideOnPointerEnter)
            {
                QUI.Space(-24);
                QUI.BeginHorizontal(width);
                {
            ...
            if (QUI.BeginFadeGroup(UIToggleOnPointerEnterAnimBool.faded))
            {
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    DUI.DUISettings.UIToggle_Inspector_HideOnPointerEnter = QUI.Toggle(DUI.DUISettings.UIToggle_Inspector_HideOnPointerEnter);
                    QUI.Label("Hide in Inspector", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 86, 18);
                    if (DUI.DUISettings.UIToggle_Inspector_HideOnPointerEnter) { DUI.DUISettings.UIToggle_useOnPointerEnter = false; }
                    QUI.Space(16);
                    DUI.DUISettings.UIToggle_useOnPointerEnter = QUI.Toggle(DUI.DUISettings.UIToggle_useOnPointerEnter);
                    QUI.Label("Enabled", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 42, 18);
                    QUI.Space(16);
                    QUI.Label("Disable Interval", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 76, 18);
                    DUI.DUISettings.UIToggle_onPointerEnterDisableInterval = EditorGUILayout.FloatField(DUI.DUISettings.UIToggle_onPointerEnterDisableInterval, GUILayout.Width(40));
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Toggle ON - Play Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 120, 18);
                    DUI.DUISettings.UIToggle_onPointerEnterSoundToggleOn = EditorGUILayout.TextArea(DUI.DUISettings.UIToggle_onPointerEnterSoundToggleOn, GUILayout.Width(160));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_customOnPointerEnterSoundToggleOn = QUI.Toggle(DUI.DUISettings.UIToggle_customOnPointerEnterSoundToggleOn);
                    QUI.Label("Custom Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 72, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                ...
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Toggle OFF - Play Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 120, 18);
                    DUI.DUISettings.UIToggle_onPointerEnterSoundToggleOff = EditorGUILayout.TextArea(DUI.DUISettings.UIToggle_onPointerEnterSoundToggleOff, GUILayout.Width(160));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_customOnPointerEnterSoundToggleOff = QUI.Toggle(DUI.DUISettings.UIToggle_customOnPointerEnterSoundToggleOff);
                    QUI.Label("Custom Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 72, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Preset Category", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 80, 18);
                    DUI.DUISettings.UIToggle_onPointerEnterPunchPresetCategory = EditorGUILayout.TextField(DUI.DUISettings.UIToggle_onPointerEnterPunchPresetCategory, GUILayout.Width(200));
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Preset Name", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 80, 18);
                    DUI.DUISettings.UIToggle_onPointerEnterPunchPresetName = EditorGUILayout.TextField(DUI.DUISettings.UIToggle_onPointerEnterPunchPresetName, GUILayout.Width(200));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_loadOnPointerEnterPunchPresetAtRuntime = QUI.Toggle(DUI.DUISettings.UIToggle_loadOnPointerEnterPunchPresetAtRuntime);
                    QUI.Label("Load preset at runtime", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 110, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
        ...
        {
            if (ButtonBar("OnPointerExit", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelNormal), UIToggleOnPointerExitAnimBool, width)) { UIToggleOnPointerExitAnimBool.target = !UIToggleOnPointerExitAnimBool.target; }
            if (DUI.DUISettings.UIToggle_Inspector_HideOnPointerExit)
            {
                QUI.Space(-24);
                QUI.BeginHorizontal(width);
                {
            ...
            if (QUI.BeginFadeGroup(UIToggleOnPointerExitAnimBool.faded))
            {
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    DUI.DUISettings.UIToggle_Inspector_HideOnPointerExit = QUI.Toggle(DUI.DUISettings.UIToggle_Inspector_HideOnPointerExit);
                    QUI.Label("Hide in Inspector", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 86, 18);
                    if (DUI.DUISettings.UIToggle_Inspector_HideOnPointerExit) { DUI.DUISettings.UIToggle_useOnPointerExit = false; }
                    QUI.Space(16);
                    DUI.DUISettings.UIToggle_useOnPointerExit = QUI.Toggle(DUI.DUISettings.UIToggle_useOnPointerExit);
                    QUI.Label("Enabled", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 42, 18);
                    QUI.Space(16);
                    QUI.Label("Disable Interval", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 76, 18);
                    DUI.DUISettings.UIToggle_onPointerExitDisableInterval = EditorGUILayout.FloatField(DUI.DUISettings.UIToggle_onPointerExitDisableInterval, GUILayout.Width(40));
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Toggle ON - Play Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 120, 18);
                    DUI.DUISettings.UIToggle_onPointerExitSoundToggleOn = EditorGUILayout.TextArea(DUI.DUISettings.UIToggle_onPointerExitSoundToggleOn, GUILayout.Width(160));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_customOnPointerExitSoundToggleOn = QUI.Toggle(DUI.DUISettings.UIToggle_customOnPointerExitSoundToggleOn);
                    QUI.Label("Custom Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 72, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Toggle OFF - Play Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 120, 18);
                    DUI.DUISettings.UIToggle_onPointerExitSoundToggleOff = EditorGUILayout.TextArea(DUI.DUISettings.UIToggle_onPointerExitSoundToggleOff, GUILayout.Width(160));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_customOnPointerExitSoundToggleOff = QUI.Toggle(DUI.DUISettings.UIToggle_customOnPointerExitSoundToggleOff);
                    QUI.Label("Custom Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 72, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Preset Category", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 80, 18);
                    DUI.DUISettings.UIToggle_onPointerExitPunchPresetCategory = EditorGUILayout.TextField(DUI.DUISettings.UIToggle_onPointerExitPunchPresetCategory, GUILayout.Width(200));
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Preset Name", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 80, 18);
                    DUI.DUISettings.UIToggle_onPointerExitPunchPresetName = EditorGUILayout.TextField(DUI.DUISettings.UIToggle_onPointerExitPunchPresetName, GUILayout.Width(200));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_loadOnPointerExitPunchPresetAtRuntime = QUI.Toggle(DUI.DUISettings.UIToggle_loadOnPointerExitPunchPresetAtRuntime);
                    QUI.Label("Load preset at runtime", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 110, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
        ...
        {
            if (ButtonBar("OnClick", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelNormal), UIToggleOnClickAnimBool, width)) { UIToggleOnClickAnimBool.target = !UIToggleOnClickAnimBool.target; }
            if (DUI.DUISettings.UIToggle_Inspector_HideOnClick)
            {
                QUI.Space(-24);
                QUI.BeginHorizontal(width);
                {
            ...
            if (QUI.BeginFadeGroup(UIToggleOnClickAnimBool.faded))
            {
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    DUI.DUISettings.UIToggle_Inspector_HideOnClick = QUI.Toggle(DUI.DUISettings.UIToggle_Inspector_HideOnClick);
                    QUI.Label("Hide in Inspector", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 86, 18);
                    if (DUI.DUISettings.UIToggle_Inspector_HideOnClick) { DUI.DUISettings.UIToggle_useOnClickAnimations = false; }
                    QUI.Space(16);
                    DUI.DUISettings.UIToggle_useOnClickAnimations = QUI.Toggle(DUI.DUISettings.UIToggle_useOnClickAnimations);
                    QUI.Label("Enabled", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 42, 18);
                    QUI.Space(16);
                    DUI.DUISettings.UIToggle_waitForOnClickAnimation = QUI.Toggle(DUI.DUISettings.UIToggle_waitForOnClickAnimation);
                    QUI.Label("Wait for Animation", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 90, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Toggle ON - Play Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 120, 18);
                    DUI.DUISettings.UIToggle_onClickSoundToggleOn = EditorGUILayout.TextArea(DUI.DUISettings.UIToggle_onClickSoundToggleOn, GUILayout.Width(160));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_customOnClickSoundToggleOn = QUI.Toggle(DUI.DUISettings.UIToggle_customOnClickSoundToggleOn);
                    QUI.Label("Custom Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 72, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Toggle OFF - Play Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 120, 18);
                    DUI.DUISettings.UIToggle_onClickSoundToggleOff = EditorGUILayout.TextArea(DUI.DUISettings.UIToggle_onClickSoundToggleOff, GUILayout.Width(160));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_customOnClickSoundToggleOff = QUI.Toggle(DUI.DUISettings.UIToggle_customOnClickSoundToggleOff);
                    QUI.Label("Custom Sound", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 72, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Preset Category", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 80, 18);
                    DUI.DUISettings.UIToggle_onClickPunchPresetCategory = EditorGUILayout.TextField(DUI.DUISettings.UIToggle_onClickPunchPresetCategory, GUILayout.Width(200));
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
                QUI.BeginHorizontal(width - INDENT_24);
                {
                    QUI.Space(INDENT_24);
                    QUI.Label("Preset Name", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 80, 18);
                    DUI.DUISettings.UIToggle_onClickPunchPresetName = EditorGUILayout.TextField(DUI.DUISettings.UIToggle_onClickPunchPresetName, GUILayout.Width(200));
                    QUI.Space(4);
                    DUI.DUISettings.UIToggle_loadOnClickPunchPresetAtRuntime = QUI.Toggle(DUI.DUISettings.UIToggle_loadOnClickPunchPresetAtRuntime);
                    QUI.Label("Load preset at runtime", DUIStyles.GetStyle(DUIStyles.BlackTextStyle.BlackLabelSmall), 110, 18);
                    QUI.FlexibleSpace();
                }
                QUI.EndHorizontal();
