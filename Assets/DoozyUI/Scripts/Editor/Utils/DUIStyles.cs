...
namespace DoozyUI
{
    public class DUIStyles
    {
        ...
        public enum ControlPanel
        {
            ...
            PageControlPanelButtonTextMeshProEnabled,
            PageControlPanelButtonTextMeshProDisabled,
            ...
            PageControlPanelButtonSceneLoaderEnabled,
            PageControlPanelButtonSceneLoaderDisabled,
        ...
        private static List<GUIStyle> ControlPanelStyles()
        {
            List<GUIStyle> styles = new List<GUIStyle>
            {
                ...
                GetButtonStyle(ControlPanel.PageControlPanelButtonTextMeshProEnabled, DUIResources.pageControlPanelButtonTextMeshProEnabled),
                GetButtonStyle(ControlPanel.PageControlPanelButtonTextMeshProDisabled, DUIResources.pageControlPanelButtonTextMeshProDisabled),
                ...
                GetButtonStyle(ControlPanel.PageControlPanelButtonSceneLoaderEnabled, DUIResources.pageControlPanelButtonSceneLoaderEnabled),
                GetButtonStyle(ControlPanel.PageControlPanelButtonSceneLoaderDisabled, DUIResources.pageControlPanelButtonSceneLoaderDisabled),
