...
namespace DoozyUI
{
    public partial class DUIResources
    {
        ...
        public static QTexture barToggleOn = new QTexture(ImagesBarsPath, "barToggleOn");
        public static QTexture barToggleOff = new QTexture(ImagesBarsPath, "barToggleOff");

        public static QTexture minibarToggleOn = new QTexture(ImagesBarsPath, "minibarToggleOn");
        public static QTexture minibarToggleOff = new QTexture(ImagesBarsPath, "minibarToggleOff");
        ...
        public static QTexture pageControlPanelButtonTextMeshProEnabled = new QTexture(ImagesControlPanelPath, "pageControlPanelButtonTextMeshProEnabled");
        public static QTexture pageControlPanelButtonTextMeshProDisabled = new QTexture(ImagesControlPanelPath, "pageControlPanelButtonTextMeshProDisabled");
        ...
        public static QTexture pageControlPanelButtonSceneLoaderEnabled = new QTexture(ImagesControlPanelPath, "pageControlPanelButtonSceneLoaderEnabled");
        public static QTexture pageControlPanelButtonSceneLoaderDisabled = new QTexture(ImagesControlPanelPath, "pageControlPanelButtonSceneLoaderDisabled");
